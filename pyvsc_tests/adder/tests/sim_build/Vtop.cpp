...
void Vtop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/divya/Downloads/cocotb-master/examples/adder/tests/../hdl/adder.sv", 6, "",
...
VL_INLINE_OPT void Vtop::_combo__TOP__2(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->adder__DOT__X = (0x1fU & ((IData)(vlTOPp->A) 
                                      + (IData)(vlTOPp->B)));
    vlTOPp->X = vlTOPp->adder__DOT__X;
}
